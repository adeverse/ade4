...
This data set contains information about spatial distribution of bird
species in a zone surrounding the river Rhône near Lyon (France).
...
Michelot, J.L., Pautou, G., Rostan, J.C., Tachet, H. and Thioulouse, J.
(1990). *Peuplements d'oiseaux et propriétés des écocomplexes de la
plaine du Rhône : descripteurs de fonctionnement global et gestion des
berges.* Rapport programme S.R.E.T.I.E., Ministère de l'Environnement
CORA et URA CNRS 367, Univ. Lyon I.
...
See a data description at <http://pbil.univ-lyon1.fr/R/pdf/pps051.pdf>
(in French).
