...
- tab:
  ...
  contains the 49 deposit samples, 9 diameter classes, weight of grains
  by size class
...
Gaschignard-Fossati, O. (1986) *Répartition spatiale des
macroinvertébrés benthiques d'un bras vif du Rhône. Rôle des crues et
dynamique saisonnière.* Thèse de doctorat, Université Lyon 1.
