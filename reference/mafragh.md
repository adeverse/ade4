...
This data set gives environmental and spatial informations about species
and sites.
...
- traits:
  ...
  a list of data frame. Each data frame provides the value of biological
  traits for plant species
...
de Bélair, Gérard and Bencheikh-Lehocine, Mahmoud (1987) Composition et
déterminisme de la végétation d'une plaine côtière marécageuse : La
Mafragh (Annaba, Algérie). *Bulletin d'Ecologie*, **18**(4), 393–407.

Pavoine, S., Vela, E., Gachet, S., de Bélair, G. and Bonsall, M. B.
(2011) Linking patterns in phylogeny, traits, abiotic variables and
space: a novel approach to linking environmental filtering and plant
community assembly. *Journal of Ecology*, **99**, 165–175.
doi:10.1111/j.1365-2745.2010.01743.x

## References

See a data description at <http://pbil.univ-lyon1.fr/R/pdf/pps053.pdf>
(in French).
