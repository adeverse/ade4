...
linear combinations of traits and environmental variables of maximal
covariance.
...
- x:
  ...
  `wca.rlq` function. An object of class `witrlq` for the `print` and
  `plot` functions
...
The `wca.rlq` function returns an object of class 'betrlq' (sub-class of
