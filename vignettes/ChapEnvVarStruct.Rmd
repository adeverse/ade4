...
`table.value(scale(env), symbol = "circle")`  
 <img src="Fig-TabvalueEnv.png" alt="Fig-TabvalueEnv.png" width="500"/>
...
`s1 <- superpose(st1, sl1, plot = TRUE)`   
 ...
 <img src="Fig-CartoDoubs.png" alt="Fig-CartoDoubs.png" width="500"/>
...
`psub.cex = 2, method = "color", symbol = "circle", ppalette.quanti = mypal, ppoints.cex = 0.5)`  
 ...
 <img src="Fig-CartoVarDoubs.png" alt="Fig-CartoVarDoubs.png" width="500"/>
...
For example, in the following figure, the user should keep (from left to right) 2, 3 and 4 axes.
 ...
 <img src="Fig-BPex.png" alt="Fig-BPex.png" width="500"/>
...
`screeplot(pca1, main=" ", xlab=" ")`  
 ...
 <img src="Fig-BPPCADoubs.png" alt="Fig-BPPCADoubs.png" width="500"/>
...
`ADEgS(list(sc1, sl1))`  
 ...
 <img src="Fig-F1xF2PCADoubs.png" alt="Fig-F1xF2PCADoubs.png" width="600"/>
...
`symbol = "circle", col = mypal(2), ppoints.cex = 1)`  
 ...
 <img src="Fig-CartoF1F2Doubs.png" alt="Fig-CartoF1F2Doubs.png" width="600"/>
...
<img src="Fig-RecodeVar.png" alt="Fig-RecodeVar.png" width="400"/>
...
<img src="Fig-BPACMDoubs.png" alt="Fig-BPACMDoubs" width="400"/>
...
<img src="Fig-ACMDoubs.png" alt="Fig-ACMDoubs.png" width="600"/>
...
<img src="Fig-scoreACMDoubs.png" alt="Fig-scoreACMDoubs.png" width="600"/>
...
<img src="Fig-plotACMDoubs.png" alt="Fig-plotACMDoubs.png" width="600"/>
...
<img src="Fig-scatterHS1.png" alt="Fig-scatterHS1" width="600"/>
...
`score(hs1, col = TRUE)`  
<img src="Fig-scoreHS1.png" alt="Fig-scoreHS1" width="600"/>

These values are also stored in `hs1$cr`:

`hs1$cr`   
`.       RS1      RS2`   
`dfs 0.70222 0.840069`   
`alt 0.65252 0.741726`   
`slo 0.41026 0.157049`   
`flo 0.63965 0.633381`   
`pH  0.02332 0.225875`   
`har 0.42895 0.320770`   
`pho 0.75512 0.046149`   
`nit 0.85903 0.008401`   
`amm 0.70428 0.069365`   
`oxy 0.61287 0.202631`   
`bdo 0.63870 0.126527`   
