...
You can also find a list of functions available to users on our [reference page](http://adeverse.github.io/ade4/reference/index.html).
...
You can also find hereafter some [papers](http://adeverse.github.io/ade4/articles/papers.html) to help you understand `ade4` methods.
...
You can swing by our [FAQ section](http://adeverse.github.io/ade4/articles/faq.html) to check if your question has already been answered or ask for help on the `ade4` mailing list [adelist](https://listes.univ-lyon1.fr/sympa/info/adelist).
